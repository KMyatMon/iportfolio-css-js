(function() {
  ...
  //       document.getElementById("theme").setAttribute("content","#000000e0");
  //       // console.log("dark")
  //       ab.checked = false
  ...
  //       document.getElementById("theme").setAttribute("content","#ffffff");
  //       // console.log("light")
  //       ab.checked = true
